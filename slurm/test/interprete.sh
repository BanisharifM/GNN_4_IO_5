...
srun python analysis/interpretability/test_methods.py \
    --checkpoint /work/hdd/bdau/mbanisharifdehkordi/GNN_4_IO_5/experiments/gat_exp_20250814_023327/checkpoints/best_model.pt \
    ...
    --device cuda \
    --output-dir /work/hdd/bdau/mbanisharifdehkordi/GNN_4_IO_5/analysis/results/1M_C6 \
    --visualize-nodes 61 62 70 0 12 13 30 46 15 43 86 25 38 30 229 56 86 19 22