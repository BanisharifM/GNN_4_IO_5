...
#SBATCH --output=logs/slurm/training_1M_C7_48H_%j.out
#SBATCH --error=logs/slurm/training_1M_C7_48H_%j.err
...
# Set Config path
CONFIG="/work/hdd/bdau/mbanisharifdehkordi/GNN_4_IO_5/configs/gat_config7.yaml"
